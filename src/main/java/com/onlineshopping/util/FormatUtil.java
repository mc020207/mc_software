...
public final class FormatUtil {
    ...
    * @Author: Lin-Yanjun
    */
    public static void checkNull(String field, Object object) throws ServiceException {
        if (object == null)
