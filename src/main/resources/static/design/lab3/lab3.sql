...
ALTER TABLE `account`
    ADD CONSTRAINT `fk_account_user_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `flow`
    ADD CONSTRAINT `fk_flow_account_1` FOREIGN KEY (`accountIdFrom`) REFERENCES `account` (`accountId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `flow`
    ADD CONSTRAINT `fk_flow_account_2` FOREIGN KEY (`accountIdTo`) REFERENCES `account` (`accountId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `order`
    ADD CONSTRAINT `fk_order_user_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `order`
    ADD CONSTRAINT `fk_order_product_1` FOREIGN KEY (`productId`) REFERENCES `product` (`productId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `product`
    ADD CONSTRAINT `fk_product_shop_1` FOREIGN KEY (`shopId`) REFERENCES `shop` (`shopId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `productImg`
    ADD CONSTRAINT `fk_productImg_product_1` FOREIGN KEY (`productId`) REFERENCES `product` (`productId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `productRecord`
    ADD CONSTRAINT `fk_productRecord_product_1` FOREIGN KEY (`productId`) REFERENCES `product` (`productId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `shop`
    ADD CONSTRAINT `fk_shop_user_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `shopRecord`
    ADD CONSTRAINT `fk_shopRecord_shop_1` FOREIGN KEY (`shopId`) REFERENCES `shop` (`shopId`) ON DELETE CASCADE ON UPDATE CASCADE;
